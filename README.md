...
File	Description
ClientApp.java	This component contains the Main method. It's the entry point of the program.
LockedMe.java	This component contains methods for displaying menu options.
